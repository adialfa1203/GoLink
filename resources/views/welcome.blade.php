                            ...
                            <div class="card mid" style="background-color: #F0F0F0;">
                                <div class="card-body">
                                    ...
                                    <div class="progress" data-bs-toggle="tooltip"
                                        ...
                                        <div class="progress-bar-microsite progress-bar-striped progress-bar-animated"
                                            ...
                                            <div class="modal-body">
                                                <div class="row g-3">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="text-muted microsite mb-0">
                                                            <b>
                                                                {{ $countMicrosite }} dari
                                                                @if (auth()->user()->subscribe == 'platinum')
                                                                Unlimited
    ...
    <div class="">
                            <div class="card mid" style="background-color: #F0F0F0;">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0" style="color: #0E2954;">
                                        <b>
                                            {{ $countURL }} dari
                                            @if (auth()->user()->subscribe == 'platinum')
                                            Unlimited
...
@section('script')
    ...
    <script>
        ...
        var progressBar = document.querySelector('.progress-bar-microsite');
