                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="position-relative">
                                                            <input name="email" type="text" class="form-control password-input" id="email" placeholder="Masukkan Email" value="{{ $admin->email }}">
                                                        </div>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="newPassword" class="form-label tex">Kata sandi
                                                            baru</label>
                                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                                            <input name="new_password" id="newPassword" type="password" class="form-control pe-5 password-input " placeholder="Kata sandi baru">
                                                            <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon">
                                                                <i class="ri-eye-fill align-middle"></i>
                                                            </button>
                                                            <div id="newPasswordError" class="text-danger mt-2"></div>
                                                            <div id="newPasswordSuccess" class="text-success mt-2"></div>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="emailInput" class="form-label tex">Konfirmasi
                                                            ...
                                                            baru</label>
                                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                                            <input name="new_password_confirmation" id="confirmPassword" type="password" class="form-control pe-5 password-input " placeholder="Konfirmasi kata sandi">
                                                            <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon">
                                                                <i class="ri-eye-fill align-middle"></i>
                                                            </button>
