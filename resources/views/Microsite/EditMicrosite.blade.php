                                            ...
                                            <div class="accordion" id="default-accordion-example">
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingOne">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#{{ $data->button->name_button }}" aria-expanded="false" aria-controls="{{ $data->button->name_button }}">
                                                            Silahkan isi URL {{ $data->button->name_button }} anda
                                                            disini! (Wajib)
                                                        </button>
                                                    </h2>
                                                    <div id="{{ $data->button->name_button }}" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#default-accordion-example">
                        ...
                        <div class="row mt-4">
                            <div class="col-8 col-lg-6 col-xl-6 col-md-8 col-sm-8">
                                <button type="button" class="btn" style="background-color: #0E2954;color: #fff;" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
                                    <span class="icon-on"><i class="ri-add-line align-bottom me-1"></i> Tambah Button</span></button>
                            </div>
                            ...
                            <button type="submit" class="btn" style="background-color: #088C0D;color: #fff;">
                                    <span class="icon-on"><i class="ri-add-line align-bottom me-1"></i> Kirim</span></button>
                            </div>
                        </div>
                    </div>
                </div><!-- end card-body -->
                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body border-top">
                            <div class="d-flex flex-wrap justify-content-center text-center mb-4">
                                ...
                                <div class="mb-2 mx-2">
                                    <button style="color: white;" type="button" class="btn btn-icon
                            ...
                            @foreach ($social as $socialItem)
                            <button style="color: white;" type="button" class="col-12 mb-2 btn btn-label rounded-pill
                                @if (strtolower(trim($socialItem->button->icon)) === 'bi bi-facebook') face
                                ...
                                <i style="color: white" class="{{ $socialItem->button->icon }} label-icon align-middle rounded-pill fs-lg me-2"></i>
