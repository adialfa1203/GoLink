...
<div class="page-content" style="background-color: white;">
                                            ...
                                            <div class="accordion" id="default-accordion-example">
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingOne">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#data{{ $data->id }}" aria-expanded="false" aria-controls="data{{ $data->id }}">
                                                            Silahkan isi URL {{ $data->button->name_button }} anda
                                                            disini! (Wajib)
                                                        </button>
                                                    </h2>
                                                    <div id="data{{ $data->id }}" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#default-accordion-example">
                                                        <div class="accordion-body">
                                                            <div class="col-xxl-12">
                                                                <div>
                                                                    ...
                                                                    <input type="text" class="form-control" id="placeholderInput" placeholder="Isi Link {{ $data->button->name_button }} Anda " name="button_link[{{ $data->id }}]" value="{{ old('button_link.' . $data->id, $data->button_link) }}">
                ...
                <div class="card real-estate-grid-widgets card-animate" style="box-shadow: 2px 5px 4px 0px rgba(0, 0, 0, 0.25);">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body border-top">
                            ...
                            <button style="color: white;" type="button" class="col-xl-12 col-12 mt-2 btn btn-label rounded-pill twi">
                                <i class="{{ $socialItem->button->icon }} label-icon align-middle rounded-pill fs-lg me-2" style="color: white;"></i>
                                <p style="margin: 0; margin-left:-8%;">{{ $socialItem->button->name_button }}
                                </p>
                            </button>
                            @elseif ($socialItem->button->icon === 'bi bi-instagram')
                            <button style="color: white;" type="button" class="col-xl-12 col-12 mt-2 btn btn-label rounded-pill insta">
                                <i class="{{ $socialItem->button->icon }} label-icon align-middle rounded-pill fs-lg me-2" style="color: white;"></i>
                                <p style="margin: 0; margin-left:-8%;">{{ $socialItem->button->name_button }}
                                </p>
                            </button>
                            @elseif ($socialItem->button->icon === 'bi bi-linkedin')
                            <button style="color: white;" type="button" class="col-xl-12 col-12 mt-2 btn btn-label rounded-pill link">
                                <i class="{{ $socialItem->button->icon }} label-icon align-middle rounded-pill fs-lg me-2" style="color: white;"></i>
                                <p style="margin: 0; margin-left:-8%;">{{ $socialItem->button->name_button }}
                                </p>
                            </button>
                            @elseif ($socialItem->button->icon === 'bi bi-telegram')
                            <button style="color: white;" type="button" class="col-xl-12 col-12 mt-2 btn btn-label rounded-pill tele">
                                <i class="{{ $socialItem->button->icon }} label-icon align-middle rounded-pill fs-lg me-2" style="color: white;"></i>
                                <p style="margin: 0; margin-left:-8%;">{{ $socialItem->button->name_button }}
                                </p>
                            </button>
                            @elseif ($socialItem->button->icon === 'bi bi-tiktok')
                            <button style="color: white;" type="button" class="col-xl-12 col-12 mt-2 btn btn-label rounded-pill tiktok">
                                <i class="{{ $socialItem->button->icon }} label-icon align-middle rounded-pill fs-lg me-2" style="color: white;"></i>
                                <p style="margin: 0; margin-left:-8%;">{{ $socialItem->button->name_button }}
                                </p>
                            </button>
                            @elseif ($socialItem->button->icon === 'bi bi-spotify')
                            <button style="color: white;" type="button" class="col-xl-12 col-12 mt-2 btn btn-label rounded-pill spo">
                                <i class="{{ $socialItem->button->icon }} label-icon align-middle rounded-pill fs-lg me-2" style="color: white;"></i>
                                <p style="margin: 0; margin-left:-8%;">{{ $socialItem->button->name_button }}
                                </p>
                            </button>
                            @elseif ($socialItem->button->icon === 'bi bi-youtube')
                            <button style="color: white;" type="button" class="col-xl-12 col-12 mt-2 btn btn-label rounded-pill youtube">
                                <i class="{{ $socialItem->button->icon }} label-icon align-middle rounded-pill fs-lg me-2" style="color: white;"></i>
                                <p style="margin: 0; margin-left:-8%;">{{ $socialItem->button->name_button }}
                                </p>
                            </button>
                            @elseif ($socialItem->button->icon === 'bi bi-bag-fill')
                            <button style="color: white;" type="button" class="col-xl-12 col-12 mt-2 btn btn-label rounded-pill olshop">
                                <i class="{{ $socialItem->button->icon }} label-icon align-middle rounded-pill fs-lg me-2" style="color: white;"></i>
                                <p style="margin: 0; margin-left:-8%;">{{ $socialItem->button->name_button }}
                                </p>
                            </button>
                            @else
                            <button style="color:#fff;background-color: {{ $socialItem->button->color_hex }}; width: 100%;" type="button" class="col-xl-012 col-12 mt-2 btn btn-label rounded-pill">
    ...
    <form action="{{ route('save-button-social') }}" method="post" class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        @csrf
                                ...
                                <label class="mb-0 me-2" for="button_uuid{{ $data->id }}">
                                    <div class="card-footer text-center">
                                        <div class="d-flex align-items-center justify-content-end">
                                            <input type="radio" id="button_uuid{{ $data->id }}" name="button_uuid" value="{{ $data->id }}" class="radio d-none">
                                            @switch($data->icon)
                                            @case('bi bi-facebook')
                                            ...
                                            <a style="color: white; background-color: {{ $data->color_hex }};" type="button" class="col-xl-12 col-12 btn btn-label rounded-pill {{ $buttonClass }}">
                        ...
                        <form action="{{ route('custom.btn.save') }}" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="col-xl-12 mt-2 col-md-6">
                                <div>
                                    ...
                                    <input type="color" class="form-control form-control-color w-100" id="colorPicker" name="color_hex" required value="{{ old('color_hex') }}" style="height: 40px;">
                                    <div class="invalid-feedback">
                                        Harap isi kolom ini sebelum melanjutkan proses.
                                    </div>
                                </div>
