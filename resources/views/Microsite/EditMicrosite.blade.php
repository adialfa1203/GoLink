                                ...
                                <div class="d-flex flex-wrap justify-content-center text-center mb-4">
                                    @foreach ($social as $socialItem)
                                        <div class="mb-2 mx-2">
                                            ...
                                            @else
                                                <button
                                                    style="color:#fff;background-color: {{ $socialItem->button->color_hex }};"
                            ...
                            @foreach ($button as $data)
                                <div class="col-xl-12 col-sm-12 mb-4">
                                    <div class="card" id="{{ $data->id }}"
                                        ...
                                        <label class="mb-0 me-2" for="button{{ $data->id }}">
                                        <div class="card-footer text-center">
                                            <div class="d-flex align-items-center justify-content-end">
                                                    <input type="radio" id="button_uuid" name="button_uuid"
                                                        value="{{ $data->id }}" class="radio" id="button{{ $data->id }}">
                                                @switch($data->icon)
                                                    @case('bi bi-facebook')
                                                ...
                                                <button style="color: white; background-color: {{ $data->color_hex }};"
                                                    type="button"
