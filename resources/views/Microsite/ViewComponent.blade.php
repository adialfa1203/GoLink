            ...
            <div class="row mt-4">
                ...
                <div class="kotak">
                    ...
                    <div class="card" style="background-color: #F0F0F0; box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.25);">
                        <div class="card-footer text-center" style="background-color: #F0F0F0;">
                            <div class="dropdown float-end">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit-modal-{{ $item->id }}">Edit
                                    </button>
                        ...
                        <div>
                            <img src="{{ asset('component/' . $item->cover_img) }}" alt="" class="card-img-top object-fit-cover" style="height: 200px;">
                        </div>
                    ...
                    <div class="modal fade zoomIn" id="edit-modal-{{ $item->id }}" tabindex="-1" aria-labelledby="editComponentModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('update.component', ['id' => $item->id]) }}" enctype="multipart/form-data" method="POST">
                                    @csrf
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="mb-3">
                                                                <label class="form-label">Nama
                                                                    Komponen</label>
                                                                <input type="text" class="form-control" value="{{$item->component_name}}" placeholder="Designation" name="component_name">
                                                            ...
                                                            <div class="card overflow-hidden">
                                                                <div>
                                                                    <div>
                                                                        ...
                                                                        <input type="file" id="fileInput{{ $item->id }}" class="profile-foreground-img-file-input d-none" name="cover_img">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('save.component') }}" class="card" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="col-xxl-12 mt-2 col-md-12">
                            <div class="card overflow-hidden">
                                <div>
                                    <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/small/img-7.jpg') }}" alt="" id="data-img-create" class="card-img-top profile-wid-img object-fit-cover" style="height: 200px;">
                                    @if ($errors->has('cover_img'))
                                    <span class="text-danger">{{ $errors->first('cover_img') }}</span>
                                    @endif
                                    <div>
                                        <input id="profile-foreground-img-file-input-create" type="file" class="profile-foreground-img-file-input-create d-none" name="cover_img" required>
                                        <div class="invalid-feedback">
                                            Harap isi sampul dan profil sebelum melanjutkan proses.
                                        </div>
                                        <label for="profile-foreground-img-file-input-create" class="profile-photo-edit btn btn-light btn-sm position-absolute end-0 top-0 m-3">
                            ...
                            <div class="d-flex align-items-start justify-content-between gap-3">
                                <button type="button" class="btn button" style="background-color: #FF2323; color:#fff;" data-bs-dismiss="modal">
                                    Batal
                                </button>
