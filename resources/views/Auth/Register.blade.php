                                    ...
                                    <form action="{{ route('register.user') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative">
                                                <input name="name" type="text" id="name" class="form-control password-input" placeholder="Masukkan Nama Lengkap" value="{{ old('name') }}">
                                            </div>
                                            <div>
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative">
                                                <input name="email" type="text" class="form-control password-input" id="email" placeholder="Masukkan Email" value="{{ old('email') }}">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input name="password" type="password" id="newPassword" class="form-control pe-5 password-input" placeholder="Masukkan Kata Sandi" id="password-input" value="{{ old('password') }}">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="password-input">Ulangi Kata
                                                Sandi</label>
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input name="password_confirmation" type="password" id="confirmPassword" class="form-control pe-5 password-input" placeholder="Masukkan ulang Kata Sandi" id="password-input">
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon">
                                                    <i class="ri-eye-fill align-middle"></i>
                                                </button>
                                        ...
                                        <div>
                                            <input class="form-check-input" type="checkbox" name="remember" id="remember" onchange="enableButton()">
                                            <label class="form-check-label" for="remember">Saya setuju dengan
                                                <a href="#" data-bs-target="#myModal" data-bs-toggle="modal" id="privacyLink">Kebijakan
                                                    Privasi</a></label>
                                        </div>
                                        <div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>Istilah yang digunakan dalam Kebijakan Privasi
                                                            ini memiliki arti yang sama dengan <a href="{{ url('id/privacy') }}">Syarat
                                                                dan Ketentuan</a>,
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-primary w-100 custom-btn" type="submit" id="submitButton" disabled>Daftar</button>
                                        </div>
                                    </form>
                                    <center>
                                        <div class=" mt-5">
