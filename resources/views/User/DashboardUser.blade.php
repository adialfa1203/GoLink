                            ...
                            <div class="modal-content">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-12">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" name="destination_url" id="AmountInput" placeholder="http://domain-mu.id/yang-paling-panjang-disini">
                                        ...
                                        <div class="container-fluid mt-3">
                                            <div class="card">
                                                <button type="button" class=" border border-0" style="background: #0E2954;color: white; font-size: 13px; padding: 5px 10px; border-radius: 5px; display: flex; align-items: center; width: 100%; text-align: left;height: 40px">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="col-lg-12">
                                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                                        ...
                                                                        <input name="deactivated_at" type="datetime-local" id="old_password" class="form-control pe-5 time-input" min="{{ now()->format('Y-m-d\TH:i:s') }}">
                                                                        <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon">
                                                                        </button>
                                                                    </div>
                                                                    <button class=" border border-0" type="button" id="time-reset" style="background: #0E2954;color: white; font-size: 13px; padding: 5px 10px; border-radius: 5px; display: flex; align-items: center; justify-content: flex-end; float: right;">
                                                ...
                                                <button class="btn" style="background: #0E2954;color: #fff; margin-top: 1px;" type="button" data-bs-toggle="collapse" data-bs-target="#tautanberjangka" aria-expanded="false" aria-controls="collapseExample" id="toggleButton">
                                                    Tampilkan lebih banyak <i class="fa-solid fa-angle-down"></i>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="modal-footer">
                                        <button type="submit" class="btn" style="width: 100%; background: #FF2323; color: #fff ;" data-bs-toggle="modal" data-bs-target="">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <button type="button" class="btn-close" id="close-singkatkan" data-bs-dismiss="modal" aria-label="Close"></button>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-group align-items-center rounded" style="background: #E9EEF5">
                                                <input id="default_short_url" name="new_url_key" class="form-control" type="text" id="salin">
                                                ...
                                                <div class="wrapper end-0 position-absolute" style="z-index: 5">
                                                    <button class="btn btn-transparent btn-sm m-0 p-1" type="button" data-bs-toggle="collapse" data-bs-target="#edit" id="editclose" onclick="statusEdit()">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </button>
                                                    <button type="button" id="button-email" data-bs-toggle="modal" data-bs-target="#bagikan" class="btn btn-danger bg-gradient btn-sm m-1"><i class="fa-solid fa-square-share-nodes"></i>
                                                        Bagikan</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="collapse" id="edit">
                                            <div class="card">
                                                <div class="container">
                                                    ...
                                                    <button class="btn btn-danger bg-gradient border border-0 me-2" type="button" id="keluarButton" style="color: white; font-size: 13px; padding: 5px 10px; border-radius: 5px; display: flex; align-items: center; justify-content: flex-end; float: right;" onclick="closeEdit()">
                                                        <span class="bi bi-arrow-clockwise">
                                                            Batal</span>
                                                    </button>
                                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <button id="close-bagikan" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
            ...
            <div class="low mt-5">
                <div class="">
                    <div class="card mid" style="background-color: #F0F0F0;">
                        <div class="card-body">
                            <p style="color: #0E2954;font-family: Poppins;font-size: 20px;font-style: normal;font-weight: 600;line-height: normal;">Kuota</p>
                            <hr>
                            ...
                            <div class="progress" data-bs-toggle="tooltip" data-bs-title="{{ $countURL }} Tautan dibuat">
                                <div id="progress-bar" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: {{ ($countURL / $urlStatus) * 100 }}%"></div>
                            </div>
                            ...
                            <div class="progress" data-bs-toggle="tooltip" data-bs-title="{{ $countMicrosite }} Nama diubah">
                                <div class="progress-bar progress-bar-striped progress-bar-animated" id="total-microsite" role="progressbar" aria-valuenow="{{ $countMicrosite }}" aria-valuemin="0" aria-valuemax="3" style="width: {{ ($countMicrosite / $micrositeStatus) * 100 }}%"></div>
                            </div>
                        ...
                        <div class="d-flex justify-content-end pe-3" data-bs-toggle="modal" data-bs-target="#lihatlebihbanyak">
                            <p><a href="#" class="link-offset-2 text-decoration-underline link-underline-opacity-25 link-underline-opacity-100-hover" style="color: #0E2954;">Lihat
                                    lebih banyak</a></p>
                        </div>
                        {{-- modal --}}
                        <div class="modal fade" id="lihatlebihbanyak" tabindex="-1" aria-labelledby="addAmountLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            <div class="card-body">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="{{ $countURL }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ ($countURL / $urlStatus) * 100 }}%;">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-striped progress-bar-animated" id="progress-bar" role="progressbar" aria-valuenow="{{ $countMicrosite }}" aria-valuemin="0" aria-valuemax="10" style="width: {{ ($countMicrosite / $micrositeStatus) * 100 }}%;"></div>
                                                </div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-striped progress-bar-animated" id="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="5"></div>
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="modal-footer">
                                            <a href="{{ url('user/subscribe-product-user') }}" type="button" class="btn btn-danger" style="width: 100%;">
                                ...
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <div class="d-flex flex-column h-100">
                                            <p class="fs-md" style="color: #0E2954;font-family: Poppins;font-size: 20px;font-style: normal;font-weight: 600;line-height: normal;">Pengunjung Tautan</p>
                        ...
                        <div class="card mid" style="background-color: #F0F0F0;">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <div class="d-flex flex-column h-100">
                                            <p class="fs-md" style="color: #0E2954;font-family: Poppins;font-size: 20px;font-style: normal;font-weight: 600;line-height: normal;">Pengunjung Microsite</p>
                                            <h3 class="mb-0 mt-auto"><span class="counter-value" data-target="{{ $totalVisitsMicrosite }}">{{ $totalVisitsMicrosite }}</span>
                                            </h3>
                                        </div>
                                    </div>
                                    <img src="{{ asset('template/image/user.png') }} " width="50" height="50" style="margin-right: -2%; margin-top: 2%;">
