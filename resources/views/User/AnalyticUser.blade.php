        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card border-bottom border-2 card-animate kotak"
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card border-bottom border-2 card-animate kotak"
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="mt-4"><span class="counter-value"
                                    data-target="{{ $totalCountVisits }}">{{ $totalCountVisits }}</span></h4>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="card"
                        style="border-radius: 10px;border: 1px solid rgba(0, 0, 0, 0.10);background: #F0F0F0;box-shadow: 2px 5px 4px 0px rgba(0, 0, 0, 0.25);">
                        ...
                        <div class="card-body">
                            ...
                            @if (auth()->user()->subscribe == 'platinum')
                                <div class="progress" data-bs-toggle="tooltip"
                                    ...
                                    <div class="progress-bar progress-bar-striped progress-bar-animated unli"
                                        id="progress-bara" role="progressbar" aria-valuenow="{{ $countURL }}"
                            ...
                            @else
                                <div class="progress" data-bs-toggle="tooltip"
                                    ...
                                    <div class="progress-bar progress-bar-striped progress-bar-animated" id="progress-bar"
                                        ...
                                        aria-valuemax="3" style="width:{{ ($countURL / (int) $urlStatus) * 100 }}%"></div>
                                </div>
                            @endif
                            <p class="mb-0">
                                <b>
                            ...
                            @if (auth()->user()->subscribe == 'platinum')
                                <div class="progress" data-bs-toggle="tooltip"
                                    ...
                                    <div class="progress-bar progress-bar-striped progress-bar-animated unli"
                                        id="total-micrositeit" role="progressbar" aria-valuenow="{{ $countMicrosite }}"
                                        aria-valuemin="0" aria-valuemax="3"></div>
                                </div>
                            @else
                                <div class="progress" data-bs-toggle="tooltip"
                                    ...
                                    <div class="progress-bar progress-bar-striped progress-bar-animated"
                                        id="total-microsite" role="progressbar" aria-valuenow="{{ $countMicrosite }}"
...
@section('script')
    ...
    @if ($user->subscribe == 'platinum')
        <script>
            var countData = 1;
            var progressBar = document.getElementById("progress-bara");
