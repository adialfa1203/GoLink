        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4 d-none">
                    <!-- Tambahkan kelas "d-none" untuk menyembunyikan elemen ini di layar besar -->
                    <div class="card">
                        <div class="card-header fw-bold">
                            Referedata Teratas
                        </div>
                        <div class="card-body text-center">
                            ...
                            <p class="card-text text-muted">Anda perlu Berlangganan untuk bisa menikmati fitur ini.</p>
                        </div>
