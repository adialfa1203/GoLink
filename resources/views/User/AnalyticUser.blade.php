                ...
                <div class="card mid" style="background-color: #F0F0F0;min-height: 96%;box-shadow: 2px 5px 4px 0px rgba(0, 0, 0, 0.25);">
                    <div class="card-body">
                        ...
                        <div class="progress" data-bs-toggle="tooltip" data-bs-title="{{ $countURL }} Tautan dibuat">
                            <div id="progress-bar" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style=" "></div>
                        </div>
                        <br>
                        ...
                        <div class="progress" data-bs-toggle="tooltip" data-bs-title="{{ $countMicrosite }} Nama diubah">
                            <div class="progress-bar progress-bar-striped progress-bar-animated" id="total-microsite" role="progressbar" aria-valuenow="{{ $countMicrosite }}" aria-valuemin="0" aria-valuemax="3" style=""></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div id="additionalDataContainer" class="d-none">
                    ...
                    <div class="card lower" id="agenciesList">
                        <div class="card-body">
                            ...
                            <center class="mt-5">
                                ...
                                <h5 style="color: #0E2954;font-family: Poppins;font-size: 17px;font-style: normal;font-weight: 600;line-height: normal;">Anda Tidak Bisa Mengakses Fitur Ini!</h5>
                                <p style="color: #0E2954;font-family: Poppins;font-size: 13px;font-style: normal;font-weight: 400;line-height: normal;">Anda perlu Beralih ke Berlangganan Untuk Bisa Menikmati Fitur Ini</p>
                                <hr class="mt-4">
                ...
                <div class="">
                    <div class="card lower" id="agenciesList">
                        <div class="card-body">
                            <h5 class="tex">Wilayah Teratas</h5>
                            <hr>
                            <center class="mt-5">
                                <div class="box mt-5 mb-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none" style="width: 44px;height: 44px;">
                ...
                <div class="">
                    <div class="card lower" id="agenciesList">
                        <div class="card-body">
                            <h5 class="tex">Browser Teratas</h5>
                            <hr>
                            <center class="mt-5">
                                <div class="box mt-5 mb-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none" style="width: 44px;height: 44px;">
