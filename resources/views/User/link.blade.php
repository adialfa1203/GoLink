            ...
            <div class="col-12 col-sm-2 isi tabss">
                ...
                <div class="flex-shrink-0">
                    <ul class="nav nav-pills card-header-pills" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active fw-bold" data-bs-toggle="tab" href="#animation-home" role="tab" data-pagination="activePagination">
                                Tautan Aktif
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-bold" data-bs-toggle="tab" href="#animation-settings" role="tab" data-pagination="historyPagination">
                                Riwayat
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="animation-home" role="tabpanel">
                            <div class="row">
                                ...
                                <form>
                                    @csrf
                                    <div class="col-lg-12">
                                        <div class="card aa" style="border: 1px solid var(--tb-border-color-translucent); box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.25);" id="card{{ $row->id }}">
                                            <div class="card-body" style="">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-9 d-flex flex-row justify-content-end">
                                                    <button type="button" id="button-email" class="btn me-3 btn-sm" style="background-color: #0E2954;" data-bs-toggle="modal" data-bs-target="#bagikan{{ $i }}" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-share-nodes icon-white"></i>
                                                    </button>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row g-3">
                                                                        <div class="countdown-input-subscribe">
                                                                            <label class="platform" onclick="window.open(`https://www.facebook.com/sharer/sharer.php?u=${document.getElementById('default_short_url{{ $i }}').innerText}`)"><i class="bi bi-facebook"></i>
                                                                                &nbsp; Facebook</label>
                                                                        </div>
                                                                        <div class="countdown-input-subscribe">
                                                                            <label class="platform" onclick="window.open(`https://twitter.com/intent/tweet?url=${document.getElementById('default_short_url{{ $i }}').innerText}`)"><i class="bi bi-twitter"></i>
                                                                                &nbsp; Twitter</label>
                                                                        </div>
                                                                        <div class="countdown-input-subscribe">
                                                                            <label class="platform" onclick="window.open(`https://api.whatsapp.com/send?text=${document.getElementById('default_short_url{{ $i }}').innerText}`)"><i class="bi bi-whatsapp"></i>
                                                                                &nbsp; WhatsApp</label>
                                                                        </div>
                                                                        <div class="countdown-input-subscribe">
                                                                            <label class="platform" data-platform="copy" id="copyButton{{ $i }}" data-url="{{ $row->default_short_url }}" data-id-copy="{{ $i }}">
                                                                        ...
                                                                        <div class="countdown-input-subscribe">
                                                                            <a id="tombol-modal" onclick="tombolmodal('{{ $row->id }}')" type="button" data-bs-toggle="modal" data-bs-target="#tombol-modal-{{ $row->id }}" data-id="{{ $row->id }}"><i class="bi bi-qr-code"></i>
                                                                                &nbsp; QR
                                                                                Code</a>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <!-- end Modal bagikan-->
                                                    <button id="tombol-modal" onclick="tombolmodal('{{ $row->id }}')" type="button" class="btn btn-light me-3 btn-sm clickButton" style="background-color: #CED2D9" data-bs-toggle="modal" data-bs-target="#tombol-modal-{{ $row->id }}" data-id="{{ $row->id }}">
                                                        <span data-bs-toggle="tooltip" data-bs-placement="left" title="Kode QR"><i class="fa-solid fa-qrcode icon-abu"></i></span>
                                                    </button>

                                                    <button type="button" class="btn btn-light me-3 btn-sm edit-link" style="background-color: #CED2D9;" data-bs-toggle="modal" data-bs-target="#zoomInModal" data-link="{{ $row->url_key }}">
                                                        <span><i class="fa-solid fa-pen-to-square icon-abu"></i></span>
                                                    </button>
                                                </div>
                                                <br>
                                                <a href="{{ $row->default_short_url }}" target="_blank" class="garisbawah card-title mb-2">
                                            ...
                                            <div class="card-footer">
                                                <div class="d-flex flex-column flex-sm-row justify-content-between">
                                                    ...
                                                    <div class="col-12 col-sm-7 d-flex flex-row justify-content-end mt-2 mb-3 mt-sm-0">
                                                        <button type="button" class="btn btn-light  me-3 btn-sm" data-bs-toggle="modal" data-bs-target="#TimeModal-{{ $row->id }}" data-link="{{ $row->url_key }}"><span data-bs-toggle="tooltip" data-bs-placement="left" title="Tautan berbasis waktu"><i class="fa-solid fa-clock"></i>&nbsp;Atur
                                                                waktu</span></button>
                                                        <button type="button" class="btn btn-light me-3 btn-sm" data-bs-toggle="modal" data-bs-target="#zoomInModal1"><span data-bs-toggle="tooltip" data-bs-placement="left" title="Tautan terlindungi"><i class="fa-solid fa-lock"></i>&nbsp;kata
                                                                sandi</span></button>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="but">
                                                                <button type="button" class="btn" style="border-radius: 5px;border: 1px solid #FF2323;background: #FFF;" data-bs-dismiss="modal"><span style="color: #FF2323;font-family: Poppins;font-size: 14px;font-style: normal;font-weight: 700;line-height: normal;">Hapus</span></button>
                                                                <button type="button" class="btn-submit submitKustom" style="border-radius: 5px;border: 1px solid rgba(0, 0, 0, 0.10);background: #0E2954; color: #fff;">Simpan</button>
                                                            </div>
                                                        </div>
                                                    </div><!-- /.modal-content -->
                                                </div><!-- /.modal-dialog -->
                                                ...
                                                <div id="zoomInModal" class="modal fade zoomIn" tabindex="-1" aria-labelledby="zoomInModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="zoomInModalLabel">
                                                                    <i class="fa-solid fa-pen-to-square"></i>&nbsp;Kustom
                                                                    Tautan
                                                                </h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                            ...
                                            <form id="updateTime">
                                                <div id="TimeModal-{{ $row->id }}" class="modal fade Time" tabindex="-1" aria-labelledby="TimeModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="TimeModalLabel"><i class="fa-solid fa-clock"></i>&nbsp;Atur
                                                                    Waktu</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="col-lg-12 mb-3 mt-3">
                                                                    <label for="deactivated_at">Ubah
                                                                        Tanggal</label>
                                                                    <input type="datetime-local" class="form-control" name="deactivated_at" @if (!is_null($row->deactivated_at)) value="{{ \Carbon\Carbon::parse($row->deactivated_at)->format('Y-m-d\TH:i') }}" @endif
                                                                    data-id="{{ $row->id }}"
                        ...
                        <div class="tab-pane" id="animation-settings" role="tabpanel">
                            <div class="row">
                                ...
                                <form action="/archive/{{ $url->id }}">
                                    @csrf
                                    <div class="col-lg-12">
                                        <div class="card" style="border: 1px solid var(--tb-border-color-translucent); padding: 0px; box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.25);" id="card{{ $url->id }}">
                                            <div class="card-body">
                                                <h6 class="col-lg-3 col-md-4 col-sm-12">{{ $url->title }}
                                                </h6>
                                                <div class="col-lg-12 col-md-12 col-sm-9 d-flex flex-url justify-content-end">
                                                    <button disabled type="button" id="button-email" class="btn me-3 btn-sm" style="background-color: #0E2954;" data-bs-toggle="modal" data-bs-target="#bagikan{{ $i }}" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-share-nodes" style="color: #fff"></i>
                                                    </button>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-body">
                                                                    <div class="url g-3">
                                                                        ...
                                                                        <div class="countdown-input-subscribe">
                                                                            <label class="platform" data-platform="copy" id="copyButton{{ $i }}" data-url="{{ $url->default_short_url }}" data-id-copy="{{ $i }}">
                                                                                <i class="bi bi-clipboard-fill"></i>
                                                                                &nbsp; Copy
                                                                            </label>
                                                                        </div>
                                                                        ...
                                                                        <div class="countdown-input-subscribe">
                                                                            <label class="platform" onclick="window.open(` https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${document.getElementById('default_short_url{{ $i }}').innerText}`)"><i class="bi bi-qr-code"></i>
                                                                                &nbsp; QR Code</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <!-- end Modal bagikan-->
                                                    <button disabled id="tombol-modal" onclick="tombolmodal('{{ $url->id }}')" type="button" class="btn btn-light me-3 btn-sm clickButton" style="background-color: #CED2D9" data-bs-toggle="modal" data-bs-target="#tombol-modal-{{ $url->id }}" data-id="{{ $url->id }}">
                                                        <span data-bs-toggle="tooltip" data-bs-placement="left" title="Kode QR"><i class="fa-solid fa-qrcode icon-abu"></i></span>
                                                    </button>

                                                    <button disabled type="button" class="btn btn-light me-3 btn-sm edit-link" style="background-color: #CED2D9" data-bs-toggle="modal" data-bs-target="#zoomInModal" data-link="{{ $url->url_key }}">
                                                        <span><i class="fa-solid fa-pen-to-square icon-abu"></i></span>
                                                    </button>
                                                </div>
                                                <br>
                                                ...
                                                @endif
                                                <a href="{{ $url->destination_url }}" class="card-subtitle font-14 text-muted">{{ $url->destination_url }}</a>
                                            </div>
                                            <div class="card-footer">
                                                <div class="d-flex flex-column flex-sm-row justify-content-between">
                                                    <div class="d-flex col-12 col-sm-5 ">
                                                    ...
                                                    <div class="col-12 col-sm-7 d-flex flex-row justify-content-end mt-2 mt-sm-0">
                                                        <button disabled type="button" class="btn btn-light  me-3 btn-sm" data-bs-toggle="modal" data-bs-target="#TimeModal-{{ $url->id }}" data-link="{{ $url->url_key }}"><span data-bs-toggle="tooltip" data-bs-placement="left" title="Tautan berbasis waktu"><i class="fa-solid fa-clock"></i>&nbsp;Atur
                                                                waktu</span></button>
                                                        <button disabled type="button" class="btn btn-light me-3 btn-sm" data-bs-toggle="modal" data-bs-target="#zoomInModal1"><span data-bs-toggle="tooltip" data-bs-placement="left" title="Tautan terlindungi"><i class="fa-solid fa-lock"></i>&nbsp;kata
                                                                sandi</span></button>
                                                        <button disabled type="button" class="btn btn-light btn-sm" data-bs-toggle="collapse" href="#collapseExample{{ $url->id }}" role="button" aria-expanded="true" aria-controls="collapseExample{{ $url->id }}">
                                                            <i class="bi bi-bar-chart-line-fill"></i> statistik
                                                        </button>
                                                    </div>
                                            ...
                                            <!-- /.modal -->
                                            <div id="tombol-modal-{{ $url->id }}" class="modal fade zoomIn modal-sm" tabindex="-1" aria-labelledby="zoomInModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="zoomInModalLabel">
                                            ...
                                            <form id="updateTime">
                                                <div id="TimeModal-{{ $url->id }}" class="modal fade Time" tabindex="-1" aria-labelledby="TimeModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="TimeModalLabel"><i class="fa-solid fa-clock"></i>&nbsp;Atur
                                                                    Waktu</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" data-id="{{ $url->id }}"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <div class="card-body d-flex" style="background-color: #D9D9D9;">
                                                                    <p><i class="fa-solid fa-clock"></i></p>
                                                                ...
                                                                <div class="col-lg-12 mb-3">
                                                                    <label for="deactivated_at">Ubah
                                                                        Tanggal</label>
                                                                    <input type="datetime-local" class="form-control" name="deactivated_at" @if (!is_null($url->deactivated_at)) value="{{ \Carbon\Carbon::parse($url->deactivated_at)->format('Y-m-d\TH:i') }}" @endif
                                                                    data-id="{{ $url->id }}"
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Tutup</button>
                                                                <button id="submitTime" data-key="{{ $url->url_key }}" data-id="{{ $url->id }}" type="button" class="btn-submit btn btn-primary submitKustom">Simpan</button>
                                                            </div>
                                                        </div><!-- /.modal-content -->
                                                    </div><!-- /.modal-dialog -->
                                                </div><!-- /.modal -->
