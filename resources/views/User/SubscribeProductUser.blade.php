                    ...
                    @else
                        <div class="col-sm-6 col-xl-4">
                            <div class="card card-animate" style="border-radius: 10px 10px;">
                                ...
                                <div class="card-body text-white"
                                    style="background-image: linear-gradient(to bottom right, #0E2954, #104898); border-radius: 0 0 10px 10px;">
                                    <img class="mt-3" src="{{ asset('pictureSubs/' . $subs->picture) }}"
    ...
    <script>
        function showAlert(tipe) {
            Swal.fire({
                icon: 'info',
                title: 'Peringatan!',
                text: "Tidak dapat membeli paket " + tipe +
                    " karena langganan saat ini {{ Auth::user()->subscribe }}. Beli langganan lebih tinggi atau tunggu masa berakhir."
            })
        }
    </script>
@endsection
