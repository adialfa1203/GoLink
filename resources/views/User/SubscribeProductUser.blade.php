...
<style>
    ...
    overflow-y: scroll;
    height: 300px;
    scrollbar-color: #000 #00FF00; /* Track color Thumb color */
    scrollbar-width: thin; /* Auto, thin, thick */
}
...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="col-sm-12 col-xl-12x`">
            <div class="card">
                <div class="card-body" style="background-image: linear-gradient(to bottom right, #104898, #104898); border-radius: 15px;">
