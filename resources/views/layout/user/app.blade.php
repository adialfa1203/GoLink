...
<head>
    ...
    <!--Swiper slider css-->
    <link href="{{ asset('template/themesbrand.com/steex/layouts/assets/libs/swiper/swiper-bundle.min.css') }}"
        rel="stylesheet" type="text/css">
        ...
        <div id="preloader">
            <div id="status">
                <img class="animate__animated animate__bounce animate__slow animate__infinite infinite"
                    style="width: 100px" src="{{ asset('preloader.png') }}">
            </div>
        </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio">
                                    ...
                                    <label class="form-check-label p-0" for="customizer-theme01">
                                        <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/light-mode.png') }}"
                                            alt="" class="img-fluid">
                                    </label>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio">
                                    ...
                                    <label class="form-check-label p-0" for="customizer-theme02">
                                        <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/material.png') }}"
                                            alt="" class="img-fluid">
                                    </label>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio">
                                    ...
                                    <label class="form-check-label p-0" for="customizer-theme03">
                                        <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/creative.png') }}"
                                            alt="" class="img-fluid">
                                    </label>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio">
                                    ...
                                    <label class="form-check-label p-0" for="customizer-theme04">
                                        <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/minimal.png') }}"
                                            alt="" class="img-fluid">
                                    </label>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio">
                                    ...
                                    <label class="form-check-label p-0" for="customizer-theme05">
                                        <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/modern.png') }}"
                                            alt="" class="img-fluid">
                                    </label>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio">
                                    ...
                                    <label class="form-check-label p-0" for="customizer-theme06">
                                        <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/interaction.png') }}"
                                            alt="" class="img-fluid">
                                    </label>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-check card-radio dark">
                                        ...
                                        <label class="form-check-label p-0 bg-transparent" for="layout-mode-dark">
                                            <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/dark-mode.png') }}"
                                                alt="" class="img-fluid">
                                        </label>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-check card-radio brand">
                                        ...
                                        <label class="form-check-label cursor-none p-0 bg-transparent opacity-75"
                                            ...
                                            <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/brand-mode.png') }}"
                                                alt="" class="img-fluid">
                                        </label>
                                    </div>
                        ...
                        <div class="modal-body" style="padding-top:0">
                            <div class="d-flex">
                                ...
                                <p class="col-6 me-2 mb-2" style="font-size: 12px;margin-left: 22%;">
                                    <a href="/milink/chat/${data.fromUserId}" class="notification-read" data-id="${data.id}">Lihat Chat</a>
                                </p>
                            </div>
