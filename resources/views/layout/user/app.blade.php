<!doctype html>
<html lang="en" data-layout="vertical" data-sidebar="dark" data-sidebar-size="lg" data-preloader="enable" data-theme="default" data-topbar="light" data-bs-theme="light">
...
<head>
    ...
    <meta charset="utf-8">
    <title> @yield('title') | MiLink - User</title>
    ...
    <link id="fontsLink" href="{{ asset('https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&amp;display=swap') }}" rel="stylesheet">
    ...
    <style>
        ...
        #preloader {
            ...
            z-index: 9999;
            animation: preloaderAnimation 3s linear forwards;
        }
...
<body>
    ...
    <div id="preloader">
        <div id="status">
            <img class="animate__animated animate__bounce animate__slow animate__infinite infinite" style="width: 100px" src="{{ asset('preloader.png') }}">
        </div>
    </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme01">
                                    <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/light-mode.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme02">
                                    <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/material.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme03">
                                    <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/creative.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme04">
                                    <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/minimal.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme05">
                                    <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/modern.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme06">
                                    <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/interaction.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio dark">
                                    ...
                                    <label class="form-check-label p-0 bg-transparent" for="layout-mode-dark">
                                        <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/dark-mode.png') }}" alt="" class="img-fluid">
                                    </label>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-check card-radio brand">
                                    ...
                                    <label class="form-check-label cursor-none p-0 bg-transparent opacity-75" for="layout-mode-brand">
                                        <img src="{{ asset('template/themesbrand.com/steex/layouts/assets/images/custom-theme/brand-mode.png') }}" alt="" class="img-fluid">
                                    </label>
                                </div>
    ...
    <script src="{{ asset('template/code.jquery.com/jquery-3.6.0.min.js') }}"></script>
    {{-- <!-- apexcharts -->
