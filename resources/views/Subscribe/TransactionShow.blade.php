                                ...
                                <div class="modal-dialog modal-dialog-centered modal-md">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="card" style="background-color: #F0F0F0;">
                                                ...
                                                <div class="row" style="padding: 30px;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <h6 class="rata1">{{ $detailTransaction->data->payment_method }}</h6>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <h6 class="rata1">Rp.{{ number_format($detailTransaction->data->amount, 2, ',', '.') }}</h6>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                        ...
                                                        <div class="col-6">
                                                            <p class="rata1">Rp.{{ $detailTransaction->data->order_items[0]->price }}</p>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                        ...
                                                        <div class="col-6">
                                                            <p class="rata1">Rp.{{ number_format($detailTransaction->data->total_fee, 2, ',', '.') }}</p>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <p class="rata1">{{ $detailTransaction->data->customer_name }}</p>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                        ...
                                                        <div class="col-6">
                                                            <p class="rata1">{{ $detailTransaction->data->order_items[0]->name }}</p>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                        ...
                                                        <div class="col-6">
                                                            <p class="rata1">{{ $detailTransaction->data->customer_phone }}</p>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                        ...
                                                        <div class="col-6">
                                                            <p class="rata1">{{ $detailTransaction->data->reference }}</p>
                                                        </div>
                                                    </div>
                                                    <hr>
                                            ...
                                            <button type="button" class="btn mt-2" style="width:100%;background-color: #0E2954;color: #fff;" data-bs-toggle="modal" data-bs-target="#pembayaran">
