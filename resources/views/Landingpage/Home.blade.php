...
.jara{
    ...
    <div class="page_wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12" data-aos="fade-right" data-aos-duration="1500">
                        ...
                        <div class="banner_text" style="margin-top: -8px;">
                            <!-- h1 -->
                            <h2 class="jud" style="color: #ffffff;">Selamat datang di MiLink.id</h2>
                            <!-- p -->
                            <p class="isi">Ingin membuat tautan lebih singkat dan lebih mudah diingat?</p>
                            <p class="isi1">MiLink.id adalah solusi terbaik untuk Anda !</p>
                        </div>
                    </div>
                    <!-- banner slides start -->
        ...
        <section class="row_am latest_story" id="blog" style="margin: 0;">
            <!-- container start -->
            <div class="container">
        ...
        <section class="row_am latest_story" id="blog">
            <div class="container">
                ...
                <div class="row justify-content-center mt-5">
                    <!--end col-->
                    <div class="col-md-3 kot" style="margin-bottom: 2%; margin-top: 2%;">
            ...
            <!--end col-->
            <div class="col-md-3 kot" style="margin-bottom: 2%; margin-top: 2%;"">
                        <div class=" story_box jarak" style="min-height:220px" data-aos="fade-up" data-aos-duration="1500" style="height: 100%;">
                <div class="story_text">
                    <h4 style="color: #104898;">
                        <h3 style="color: #104898;" class="counter_value" data-target="{{ $totalVisits }}">{{ $totalVisits }}</h3>
                    </h4>
        ...
        <div class="container">
            ...
            <div class="company_logos" style="margin-top: 5%;">
                <div id="company_slider" class="owl-carousel owl-theme">
                    ...
                    <div class="item">
                        <div class="logo">
                            <img src="{{ $channel->icon_url }}" alt="image" style="max-width: 150px; max-height: 150px; object-fit:content">
                        </div>
                    </div>
                    @endforeach
                </div>
