...
<body>
    ...
    <style>
        ...
        .section_title h2 {
            margin-top: -20px;
            /* Sesuaikan dengan jumlah margin yang Anda butuhkan */
        }
    </style>
    <style>
        .story_box {
    ...
    <style>
        .custom-title h2 {
            font-size: 20px;
            /* Ganti 24px dengan ukuran font yang Anda inginkan */
        }
    </style>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 aos-init aos-animate d-flex justify-content-start" data-aos="fade-in"
                        ...
                        <div class="banner_image">
                            <img class="moving_animation" src="{{ asset('landing-page.png') }}" alt="image">
                        </div>
                    </div>
                    <!-- banner slides end -->
        ...
        <section class="row_am latest_story" id="blog">
            ...
            <div class="container">
                <div class="section_title" data-aos="fade-in" data-aos-duration="1500" data-aos-delay="100"
                    style="margin-top: 5%;">
                    <h2 class="custom-title"><span>Fitur fitur</span> <span>Mi</span>Link.id <span><br>Yang Dapat
                            Membantu Anda</span></h2>
                </div>
                ...
                <div class="row d-flex justify-content-md-center" style="margin-top: 7%;">
                    ...
                    <div class="col-md-4" style="margin-bottom: 2%;">
                        <div class="story_box" data-aos="fade-up" data-aos-duration="1500" style="height: 100%;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90"
                                viewBox="0 0 90 90" style="margin-top: 10%;">
                                <circle cx="45" cy="45" r="45" fill="#D9D9D9" />
                                <rect x="21" y="31" width="47.6981" height="32" rx="5" fill="#104898" />
                                <circle cx="34.2816" cy="43.0756" r="5.43396" fill="white" />
                                <path
                                    d="M28.8508 55.151C28.8508 54.4374 28.9914 53.7308 29.2645 53.0715C29.5375 52.4122 29.9378 51.8132 30.4424 51.3086C30.947 50.804 31.546 50.4038 32.2053 50.1307C32.8646 49.8576 33.5712 49.717 34.2848 49.717C34.9984 49.717 35.705 49.8576 36.3643 50.1307C37.0236 50.4038 37.6226 50.804 38.1272 51.3086C38.6318 51.8132 39.032 52.4122 39.3051 53.0715C39.5782 53.7308 39.7188 54.4374 39.7187 55.151L34.2848 55.151H28.8508Z"
                                    fill="white" />
                                <path d="M46.3594 39.7549H60.2462" stroke="white" stroke-width="3"
                                    stroke-linecap="round" />
                                <path d="M46.3594 46.6982H60.2462" stroke="white" stroke-width="3"
                                    stroke-linecap="round" />
                                <path d="M46.3594 53.9434H60.2462" stroke="white" stroke-width="3"
                                    stroke-linecap="round" />
                            </svg>
                            <div class="story_text">
                                <h3 style="color: #104898;">Pembuatan Microsite</h3>
                                <p>Buat tautan Bio Anda sendiri dengan MiLink.id. Tautan Bio Anda sekarang dapat
                                    terlihat lebih menarik dan informatif.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4" style="margin-bottom: 2%;">
                        <div class="story_box" data-aos="fade-up" data-aos-duration="1500" style="height: 100%;">
                            <svg width="90" height="90" viewBox="0 0 90 90" style="margin-top: 10%;"
                                xmlns="http://www.w3.org/2000/svg">
                                <circle cx="45" cy="45" r="45" fill="#D9D9D9" />
                                <path
                                    d="M63.75 55.1667H30V32.2083C30 31.5407 29.4406 31 28.75 31H26.25C25.5594 31 25 31.5407 25 32.2083V57.5833C25 58.9178 26.1195 60 27.5 60H63.75C64.4406 60 65 59.4593 65 58.7917V56.375C65 55.7074 64.4406 55.1667 63.75 55.1667ZM61.25 33.4167H52.0266C50.3563 33.4167 49.5195 35.3689 50.7008 36.5108L53.232 38.9576L47.5 44.4994L41.768 38.9584C40.7914 38.0144 39.2086 38.0144 38.2328 38.9584L32.8664 44.1459C32.3781 44.6179 32.3781 45.3829 32.8664 45.855L34.6336 47.5632C35.1219 48.0352 35.9133 48.0352 36.4016 47.5632L40 44.084L45.732 49.6249C46.7086 50.569 48.2914 50.569 49.2672 49.6249L56.7672 42.3749L59.2984 44.8218C60.4797 45.9637 62.4992 45.1549 62.4992 43.5402V34.625C62.5 33.9574 61.9406 33.4167 61.25 33.4167Z"
                                    fill="#104898" />
                            </svg>

                            <div class="story_text">
                                <h3 style="color: #104898;">Analitik</h3>
                                <p>Lacak kinerja tautan MiLink.id Anda dengan mudah. Identifikasi tren dan pola dalam
                                    penggunaan tautan Anda. Dengan analitik Anda dapat mengukur dampak kampanye Anda
                                    dengan lebih baik.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center mt-5">
                            ...
                            <div class="story_text">
                                <h4 style="color: #104898;">
                                    <span class="counter_value"
                                        data-target="{{ $url }}"></span>{{ $url }}</span><span>+</span>
                                </h4>
                                <p class="text-muted">
                    ...
                    <div class="col-md-3" style="margin-bottom: 2%; margin-top: 2%;"">
                        <div class="story_box" style="min-height:220px" data-aos="fade-up" data-aos-duration="1500">
                            <div class="story_text">
                                <h4 style="color: #104898;">
                                    <span class="counter_value"
                                        data-target="{{ $micrositeuuid }}">{{ $micrositeuuid }}</span><span>+</span>
                                </h4>
                                <p class="text-muted"> Sudah lebih dari {{ $micrositeuuid }} microsite yang berhasil
                                    dibuat dengan MiLink.id</p>
                            </div>
                        </div>
                    </div>
                    <!--end col-->
                    <div class="col-md-3" style="margin-bottom: 2%; margin-top: 2%;"">
                        <div class="story_box" style="min-height:220px" data-aos="fade-up" data-aos-duration="1500">
                            <div class="story_text">
                                <h4 style="color: #104898;">
                                    <h3 style="color: #104898;" class="counter_value"
                                        data-target="{{ $totalVisits }}">{{ $totalVisits }}</h3>
                                </h4>
